        ...
        <div className="px-5 py-5 border-b border-border">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">CRM + AI</div>
            </div>
          </div>
        </div>
    ...
    <div className="space-y-4">
      <div className="bg-card rounded-2xl border border-border p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <InfoRow label="AI Model" value="grok-3-latest (x.ai)" />
        </div>
        <div className="p-4 rounded-xl bg-muted text-sm text-muted-foreground space-y-2">
          <p className="font-semibold text-foreground">10 פיצ'רי AI זמינים</p>
          <p>סיכום · SEO · מאמר מלא · כותרות · תיוג · פוסט חברתי · קהל יעד · FAQ · תכנון עונתי · תזמון חכם</p>
          <p>כל פיצ'ר קורא ל-<code className="bg-background px-1 rounded text-xs">ai-crm-assistant</code> ותוצאות נשמרות ב-DB.</p>
        </div>
      </div>
    </div>
  )
